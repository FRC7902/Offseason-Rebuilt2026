...
public class FlywheelSubsystem extends SubsystemBase {
  ...
  /**
   * Runs a SysId routine on the flywheel mechanism. This command will run a series of quasistatic
   * and dynamic tests, logging the results to the Phoenix SignalLogger. The routine will stop the
   * closed-loop controller before starting and restart it after finishing. The routine will also
   * log the state of the test to the SignalLogger.
   *
    ...
    final SysIdRoutine m_sysIdRoutine =
        new SysIdRoutine(
            ...
            new SysIdRoutine.Mechanism(
                (volts) -> m_flywheelLeaderMotor.setControl(m_voltReq.withOutput(volts.in(Volts))),
                null,
                this));
  ...
  public void periodic() {
    ...
    SmartDashboard.putBoolean("ShooterFlywheelMech/isAtSetpoint", isAtSetpoint());
  }
