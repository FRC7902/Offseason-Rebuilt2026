...
public class IntakeSystem {
     ...
     * setpoint while running the intake rollers.
     *
     ...
     * then stops the intake rollers once midpoint is reached.
     *
     ...
     *
     * <p>
     * If the linear intake starts farther extended than midpoint, the command
     * runs the intake rollers until the intake retracts back to midpoint.
     *
